...
<%-- <c:forTokens items="이름1,이름1,이름1,이름1" delims=",">
<br /> 반복
</c:forTokens> --%> <!-- 아이템의 갯수 만큼 반복이 된다 -->
...
<hr />
</c:forTokens> --%> <!-- begin="1" end="3" 이 있어서 1~3까지만 나옴 -->
...
step : ${st.step } <br />
<hr />
</c:forTokens> delims는 생략할 부분들을 써 넣는다 step는 2의 배수를 출력한다 --%>
</body>
</html>